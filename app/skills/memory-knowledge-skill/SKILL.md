...
│   ├── experience_template.md     # Source template for scripts
│   └── principle_template.md      # Source template for scripts
│
...
### references/
- `experience-guide.md` - Writing guide for experience entries
- `principle-guide.md` - Writing guide for principle entries
