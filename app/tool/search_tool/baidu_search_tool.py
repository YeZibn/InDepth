...
@tool(
    ...
    description="DEPRECATED: direct Baidu search is disabled. Use search guard tools instead: init_search_guard -> guarded_ddg_search/guarded_url_search.",  # Custom description
...
def baidu_search(query: str, num_results: int = 5) -> str:
    ...
    """
    return (
        "Error: direct baidu_search is disabled by policy. "
        "Use search guard flow: "
        "init_search_guard -> guarded_ddg_search/guarded_url_search -> update_search_progress."
    )
